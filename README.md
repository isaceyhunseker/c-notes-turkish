...
- `time_t` `epoc`tan gecen sureyi ifade eder, `Epoc` sistem tarafindan belirlenmis orjin timepointidir, mesela `unix` sistemler icin 1.1.1970 noktasidir. Genellikle `long long` turunden degiskendir.
- struct `tm` kutuphane struct'i bununla ilgili bir cok elemana sahiptir.
